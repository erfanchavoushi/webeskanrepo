...
public class com_azarnush_ptmalborz_models_LawInfo2RealmProxy extends com.azarnush.ptmalborz.models.LawInfo2
    implements RealmObjectProxy, com_azarnush_ptmalborz_models_LawInfo2RealmProxyInterface {

    static final class LawInfo2ColumnInfo extends ColumnInfo {
        ...
        LawInfo2ColumnInfo(OsSchemaInfo schemaInfo) {
            super(10);
            OsObjectSchemaInfo objectSchemaInfo = schemaInfo.getObjectSchemaInfo("LawInfo2");
        ...
        LawInfo2ColumnInfo(ColumnInfo src, boolean mutable) {
            super(src, mutable);
            copy(src, this);
        }
        ...
        protected final ColumnInfo copy(boolean mutable) {
            return new LawInfo2ColumnInfo(this, mutable);
        }

        @Override
        protected final void copy(ColumnInfo rawSrc, ColumnInfo rawDst) {
            final LawInfo2ColumnInfo src = (LawInfo2ColumnInfo) rawSrc;
            final LawInfo2ColumnInfo dst = (LawInfo2ColumnInfo) rawDst;
    ...
    private LawInfo2ColumnInfo columnInfo;
    private ProxyState<com.azarnush.ptmalborz.models.LawInfo2> proxyState;

    com_azarnush_ptmalborz_models_LawInfo2RealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.columnInfo = (LawInfo2ColumnInfo) context.getColumnInfo();
        this.proxyState = new ProxyState<com.azarnush.ptmalborz.models.LawInfo2>(this);
    ...
    private static OsObjectSchemaInfo createExpectedObjectSchemaInfo() {
        OsObjectSchemaInfo.Builder builder = new OsObjectSchemaInfo.Builder("LawInfo2", 10, 0);
    ...
    public static LawInfo2ColumnInfo createColumnInfo(OsSchemaInfo schemaInfo) {
        return new LawInfo2ColumnInfo(schemaInfo);
    }
    ...
    public static final class ClassNameHelper {
        public static final String INTERNAL_CLASS_NAME = "LawInfo2";
    }

    @SuppressWarnings("cast")
    public static com.azarnush.ptmalborz.models.LawInfo2 createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        com.azarnush.ptmalborz.models.LawInfo2 obj = realm.createObjectInternal(com.azarnush.ptmalborz.models.LawInfo2.class, true, excludeFields);

        final com_azarnush_ptmalborz_models_LawInfo2RealmProxyInterface objProxy = (com_azarnush_ptmalborz_models_LawInfo2RealmProxyInterface) obj;
        if (json.has("lawId")) {
    ...
    public static com.azarnush.ptmalborz.models.LawInfo2 createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        final com.azarnush.ptmalborz.models.LawInfo2 obj = new com.azarnush.ptmalborz.models.LawInfo2();
        final com_azarnush_ptmalborz_models_LawInfo2RealmProxyInterface objProxy = (com_azarnush_ptmalborz_models_LawInfo2RealmProxyInterface) obj;
        reader.beginObject();
    ...
    private static com_azarnush_ptmalborz_models_LawInfo2RealmProxy newProxyInstance(BaseRealm realm, Row row) {
        // Ignore default values to avoid creating unexpected objects from RealmModel/RealmList fields
        final BaseRealm.RealmObjectContext objectContext = BaseRealm.objectContext.get();
        objectContext.set(realm, row, realm.getSchema().getColumnInfo(com.azarnush.ptmalborz.models.LawInfo2.class), false, Collections.<String>emptyList());
        io.realm.com_azarnush_ptmalborz_models_LawInfo2RealmProxy obj = new io.realm.com_azarnush_ptmalborz_models_LawInfo2RealmProxy();
        objectContext.clear();
        return obj;
    }

    public static com.azarnush.ptmalborz.models.LawInfo2 copyOrUpdate(Realm realm, LawInfo2ColumnInfo columnInfo, com.azarnush.ptmalborz.models.LawInfo2 object, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        ...
        if (cachedRealmObject != null) {
            return (com.azarnush.ptmalborz.models.LawInfo2) cachedRealmObject;
        }

        return copy(realm, columnInfo, object, update, cache, flags);
    }

    public static com.azarnush.ptmalborz.models.LawInfo2 copy(Realm realm, LawInfo2ColumnInfo columnInfo, com.azarnush.ptmalborz.models.LawInfo2 newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        RealmObjectProxy cachedRealmObject = cache.get(newObject);
        if (cachedRealmObject != null) {
            return (com.azarnush.ptmalborz.models.LawInfo2) cachedRealmObject;
        }

        com_azarnush_ptmalborz_models_LawInfo2RealmProxyInterface realmObjectSource = (com_azarnush_ptmalborz_models_LawInfo2RealmProxyInterface) newObject;

        Table table = realm.getTable(com.azarnush.ptmalborz.models.LawInfo2.class);
        ...
        io.realm.com_azarnush_ptmalborz_models_LawInfo2RealmProxy realmObjectCopy = newProxyInstance(realm, row);
        cache.put(newObject, realmObjectCopy);

        return realmObjectCopy;
    }

    public static long insert(Realm realm, com.azarnush.ptmalborz.models.LawInfo2 object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.azarnush.ptmalborz.models.LawInfo2.class);
        long tableNativePtr = table.getNativePtr();
        LawInfo2ColumnInfo columnInfo = (LawInfo2ColumnInfo) realm.getSchema().getColumnInfo(com.azarnush.ptmalborz.models.LawInfo2.class);
        long rowIndex = OsObject.createRow(table);
        cache.put(object, rowIndex);
        String realmGet$lawId = ((com_azarnush_ptmalborz_models_LawInfo2RealmProxyInterface) object).realmGet$lawId();
        if (realmGet$lawId != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.lawIdIndex, rowIndex, realmGet$lawId, false);
        }
        String realmGet$lawTitle = ((com_azarnush_ptmalborz_models_LawInfo2RealmProxyInterface) object).realmGet$lawTitle();
        if (realmGet$lawTitle != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.lawTitleIndex, rowIndex, realmGet$lawTitle, false);
        }
        String realmGet$lawSummary = ((com_azarnush_ptmalborz_models_LawInfo2RealmProxyInterface) object).realmGet$lawSummary();
        ...
        String realmGet$lawContent = ((com_azarnush_ptmalborz_models_LawInfo2RealmProxyInterface) object).realmGet$lawContent();
        ...
        String realmGet$lawSourceLink = ((com_azarnush_ptmalborz_models_LawInfo2RealmProxyInterface) object).realmGet$lawSourceLink();
        ...
        String realmGet$lawTag = ((com_azarnush_ptmalborz_models_LawInfo2RealmProxyInterface) object).realmGet$lawTag();
        if (realmGet$lawTag != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.lawTagIndex, rowIndex, realmGet$lawTag, false);
        }
        String realmGet$shortKey = ((com_azarnush_ptmalborz_models_LawInfo2RealmProxyInterface) object).realmGet$shortKey();
        if (realmGet$shortKey != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.shortKeyIndex, rowIndex, realmGet$shortKey, false);
        }
        String realmGet$visibleStatusId = ((com_azarnush_ptmalborz_models_LawInfo2RealmProxyInterface) object).realmGet$visibleStatusId();
        ...
        String realmGet$registerDate = ((com_azarnush_ptmalborz_models_LawInfo2RealmProxyInterface) object).realmGet$registerDate();
        ...
        String realmGet$lawGroupRefId = ((com_azarnush_ptmalborz_models_LawInfo2RealmProxyInterface) object).realmGet$lawGroupRefId();
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        long tableNativePtr = table.getNativePtr();
        LawInfo2ColumnInfo columnInfo = (LawInfo2ColumnInfo) realm.getSchema().getColumnInfo(com.azarnush.ptmalborz.models.LawInfo2.class);
        com.azarnush.ptmalborz.models.LawInfo2 object = null;
        while (objects.hasNext()) {
            object = (com.azarnush.ptmalborz.models.LawInfo2) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.azarnush.ptmalborz.models.LawInfo2 object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.azarnush.ptmalborz.models.LawInfo2.class);
    ...
    public static com.azarnush.ptmalborz.models.LawInfo2 createDetachedCopy(com.azarnush.ptmalborz.models.LawInfo2 realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.azarnush.ptmalborz.models.LawInfo2 unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.azarnush.ptmalborz.models.LawInfo2();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.azarnush.ptmalborz.models.LawInfo2) cachedObject.object;
            }
            unmanagedObject = (com.azarnush.ptmalborz.models.LawInfo2) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_azarnush_ptmalborz_models_LawInfo2RealmProxyInterface unmanagedCopy = (com_azarnush_ptmalborz_models_LawInfo2RealmProxyInterface) unmanagedObject;
        com_azarnush_ptmalborz_models_LawInfo2RealmProxyInterface realmSource = (com_azarnush_ptmalborz_models_LawInfo2RealmProxyInterface) realmObject;
    ...
    public String toString() {
        ...
        StringBuilder stringBuilder = new StringBuilder("LawInfo2 = proxy[");
    ...
    public boolean equals(Object o) {
        ...
        com_azarnush_ptmalborz_models_LawInfo2RealmProxy aLawInfo2 = (com_azarnush_ptmalborz_models_LawInfo2RealmProxy)o;

        String path = proxyState.getRealm$realm().getPath();
        String otherPath = aLawInfo2.proxyState.getRealm$realm().getPath();
        if (path != null ? !path.equals(otherPath) : otherPath != null) return false;

        String tableName = proxyState.getRow$realm().getTable().getName();
        String otherTableName = aLawInfo2.proxyState.getRow$realm().getTable().getName();
        if (tableName != null ? !tableName.equals(otherTableName) : otherTableName != null) return false;

        if (proxyState.getRow$realm().getIndex() != aLawInfo2.proxyState.getRow$realm().getIndex()) return false;
