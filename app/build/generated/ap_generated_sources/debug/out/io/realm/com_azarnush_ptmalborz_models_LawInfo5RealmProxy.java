...
public class com_azarnush_ptmalborz_models_LawInfo5RealmProxy extends com.azarnush.ptmalborz.models.LawInfo5
    implements RealmObjectProxy, com_azarnush_ptmalborz_models_LawInfo5RealmProxyInterface {

    static final class LawInfo5ColumnInfo extends ColumnInfo {
        ...
        LawInfo5ColumnInfo(OsSchemaInfo schemaInfo) {
            super(10);
            OsObjectSchemaInfo objectSchemaInfo = schemaInfo.getObjectSchemaInfo("LawInfo5");
        ...
        LawInfo5ColumnInfo(ColumnInfo src, boolean mutable) {
            super(src, mutable);
            copy(src, this);
        }
        ...
        protected final ColumnInfo copy(boolean mutable) {
            return new LawInfo5ColumnInfo(this, mutable);
        }

        @Override
        protected final void copy(ColumnInfo rawSrc, ColumnInfo rawDst) {
            final LawInfo5ColumnInfo src = (LawInfo5ColumnInfo) rawSrc;
            final LawInfo5ColumnInfo dst = (LawInfo5ColumnInfo) rawDst;
    ...
    private LawInfo5ColumnInfo columnInfo;
    private ProxyState<com.azarnush.ptmalborz.models.LawInfo5> proxyState;

    com_azarnush_ptmalborz_models_LawInfo5RealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.columnInfo = (LawInfo5ColumnInfo) context.getColumnInfo();
        this.proxyState = new ProxyState<com.azarnush.ptmalborz.models.LawInfo5>(this);
    ...
    private static OsObjectSchemaInfo createExpectedObjectSchemaInfo() {
        OsObjectSchemaInfo.Builder builder = new OsObjectSchemaInfo.Builder("LawInfo5", 10, 0);
    ...
    public static LawInfo5ColumnInfo createColumnInfo(OsSchemaInfo schemaInfo) {
        return new LawInfo5ColumnInfo(schemaInfo);
    }
    ...
    public static final class ClassNameHelper {
        public static final String INTERNAL_CLASS_NAME = "LawInfo5";
    }

    @SuppressWarnings("cast")
    public static com.azarnush.ptmalborz.models.LawInfo5 createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        com.azarnush.ptmalborz.models.LawInfo5 obj = realm.createObjectInternal(com.azarnush.ptmalborz.models.LawInfo5.class, true, excludeFields);

        final com_azarnush_ptmalborz_models_LawInfo5RealmProxyInterface objProxy = (com_azarnush_ptmalborz_models_LawInfo5RealmProxyInterface) obj;
        if (json.has("lawId")) {
    ...
    public static com.azarnush.ptmalborz.models.LawInfo5 createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        final com.azarnush.ptmalborz.models.LawInfo5 obj = new com.azarnush.ptmalborz.models.LawInfo5();
        final com_azarnush_ptmalborz_models_LawInfo5RealmProxyInterface objProxy = (com_azarnush_ptmalborz_models_LawInfo5RealmProxyInterface) obj;
        reader.beginObject();
    ...
    private static com_azarnush_ptmalborz_models_LawInfo5RealmProxy newProxyInstance(BaseRealm realm, Row row) {
        // Ignore default values to avoid creating unexpected objects from RealmModel/RealmList fields
        final BaseRealm.RealmObjectContext objectContext = BaseRealm.objectContext.get();
        objectContext.set(realm, row, realm.getSchema().getColumnInfo(com.azarnush.ptmalborz.models.LawInfo5.class), false, Collections.<String>emptyList());
        io.realm.com_azarnush_ptmalborz_models_LawInfo5RealmProxy obj = new io.realm.com_azarnush_ptmalborz_models_LawInfo5RealmProxy();
        objectContext.clear();
        return obj;
    }

    public static com.azarnush.ptmalborz.models.LawInfo5 copyOrUpdate(Realm realm, LawInfo5ColumnInfo columnInfo, com.azarnush.ptmalborz.models.LawInfo5 object, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        ...
        if (cachedRealmObject != null) {
            return (com.azarnush.ptmalborz.models.LawInfo5) cachedRealmObject;
        }

        return copy(realm, columnInfo, object, update, cache, flags);
    }

    public static com.azarnush.ptmalborz.models.LawInfo5 copy(Realm realm, LawInfo5ColumnInfo columnInfo, com.azarnush.ptmalborz.models.LawInfo5 newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        RealmObjectProxy cachedRealmObject = cache.get(newObject);
        if (cachedRealmObject != null) {
            return (com.azarnush.ptmalborz.models.LawInfo5) cachedRealmObject;
        }

        com_azarnush_ptmalborz_models_LawInfo5RealmProxyInterface realmObjectSource = (com_azarnush_ptmalborz_models_LawInfo5RealmProxyInterface) newObject;

        Table table = realm.getTable(com.azarnush.ptmalborz.models.LawInfo5.class);
        ...
        io.realm.com_azarnush_ptmalborz_models_LawInfo5RealmProxy realmObjectCopy = newProxyInstance(realm, row);
        cache.put(newObject, realmObjectCopy);

        return realmObjectCopy;
    }

    public static long insert(Realm realm, com.azarnush.ptmalborz.models.LawInfo5 object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.azarnush.ptmalborz.models.LawInfo5.class);
        long tableNativePtr = table.getNativePtr();
        LawInfo5ColumnInfo columnInfo = (LawInfo5ColumnInfo) realm.getSchema().getColumnInfo(com.azarnush.ptmalborz.models.LawInfo5.class);
        long rowIndex = OsObject.createRow(table);
        cache.put(object, rowIndex);
        String realmGet$lawId = ((com_azarnush_ptmalborz_models_LawInfo5RealmProxyInterface) object).realmGet$lawId();
        if (realmGet$lawId != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.lawIdIndex, rowIndex, realmGet$lawId, false);
        }
        String realmGet$lawTitle = ((com_azarnush_ptmalborz_models_LawInfo5RealmProxyInterface) object).realmGet$lawTitle();
        if (realmGet$lawTitle != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.lawTitleIndex, rowIndex, realmGet$lawTitle, false);
        }
        String realmGet$lawSummary = ((com_azarnush_ptmalborz_models_LawInfo5RealmProxyInterface) object).realmGet$lawSummary();
        ...
        String realmGet$lawContent = ((com_azarnush_ptmalborz_models_LawInfo5RealmProxyInterface) object).realmGet$lawContent();
        ...
        String realmGet$lawSourceLink = ((com_azarnush_ptmalborz_models_LawInfo5RealmProxyInterface) object).realmGet$lawSourceLink();
        ...
        String realmGet$lawTag = ((com_azarnush_ptmalborz_models_LawInfo5RealmProxyInterface) object).realmGet$lawTag();
        if (realmGet$lawTag != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.lawTagIndex, rowIndex, realmGet$lawTag, false);
        }
        String realmGet$shortKey = ((com_azarnush_ptmalborz_models_LawInfo5RealmProxyInterface) object).realmGet$shortKey();
        if (realmGet$shortKey != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.shortKeyIndex, rowIndex, realmGet$shortKey, false);
        }
        String realmGet$visibleStatusId = ((com_azarnush_ptmalborz_models_LawInfo5RealmProxyInterface) object).realmGet$visibleStatusId();
        ...
        String realmGet$registerDate = ((com_azarnush_ptmalborz_models_LawInfo5RealmProxyInterface) object).realmGet$registerDate();
        ...
        String realmGet$lawGroupRefId = ((com_azarnush_ptmalborz_models_LawInfo5RealmProxyInterface) object).realmGet$lawGroupRefId();
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        long tableNativePtr = table.getNativePtr();
        LawInfo5ColumnInfo columnInfo = (LawInfo5ColumnInfo) realm.getSchema().getColumnInfo(com.azarnush.ptmalborz.models.LawInfo5.class);
        com.azarnush.ptmalborz.models.LawInfo5 object = null;
        while (objects.hasNext()) {
            object = (com.azarnush.ptmalborz.models.LawInfo5) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.azarnush.ptmalborz.models.LawInfo5 object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.azarnush.ptmalborz.models.LawInfo5.class);
    ...
    public static com.azarnush.ptmalborz.models.LawInfo5 createDetachedCopy(com.azarnush.ptmalborz.models.LawInfo5 realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.azarnush.ptmalborz.models.LawInfo5 unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.azarnush.ptmalborz.models.LawInfo5();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.azarnush.ptmalborz.models.LawInfo5) cachedObject.object;
            }
            unmanagedObject = (com.azarnush.ptmalborz.models.LawInfo5) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_azarnush_ptmalborz_models_LawInfo5RealmProxyInterface unmanagedCopy = (com_azarnush_ptmalborz_models_LawInfo5RealmProxyInterface) unmanagedObject;
        com_azarnush_ptmalborz_models_LawInfo5RealmProxyInterface realmSource = (com_azarnush_ptmalborz_models_LawInfo5RealmProxyInterface) realmObject;
    ...
    public String toString() {
        ...
        StringBuilder stringBuilder = new StringBuilder("LawInfo5 = proxy[");
    ...
    public boolean equals(Object o) {
        ...
        com_azarnush_ptmalborz_models_LawInfo5RealmProxy aLawInfo5 = (com_azarnush_ptmalborz_models_LawInfo5RealmProxy)o;

        String path = proxyState.getRealm$realm().getPath();
        String otherPath = aLawInfo5.proxyState.getRealm$realm().getPath();
        if (path != null ? !path.equals(otherPath) : otherPath != null) return false;

        String tableName = proxyState.getRow$realm().getTable().getName();
        String otherTableName = aLawInfo5.proxyState.getRow$realm().getTable().getName();
        if (tableName != null ? !tableName.equals(otherTableName) : otherTableName != null) return false;

        if (proxyState.getRow$realm().getIndex() != aLawInfo5.proxyState.getRow$realm().getIndex()) return false;
