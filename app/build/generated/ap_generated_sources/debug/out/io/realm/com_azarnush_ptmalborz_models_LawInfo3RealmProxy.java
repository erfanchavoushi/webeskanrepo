...
public class com_azarnush_ptmalborz_models_LawInfo3RealmProxy extends com.azarnush.ptmalborz.models.LawInfo3
    implements RealmObjectProxy, com_azarnush_ptmalborz_models_LawInfo3RealmProxyInterface {

    static final class LawInfo3ColumnInfo extends ColumnInfo {
        ...
        LawInfo3ColumnInfo(OsSchemaInfo schemaInfo) {
            super(10);
            OsObjectSchemaInfo objectSchemaInfo = schemaInfo.getObjectSchemaInfo("LawInfo3");
        ...
        LawInfo3ColumnInfo(ColumnInfo src, boolean mutable) {
            super(src, mutable);
            copy(src, this);
        }
        ...
        protected final ColumnInfo copy(boolean mutable) {
            return new LawInfo3ColumnInfo(this, mutable);
        }

        @Override
        protected final void copy(ColumnInfo rawSrc, ColumnInfo rawDst) {
            final LawInfo3ColumnInfo src = (LawInfo3ColumnInfo) rawSrc;
            final LawInfo3ColumnInfo dst = (LawInfo3ColumnInfo) rawDst;
    ...
    private LawInfo3ColumnInfo columnInfo;
    private ProxyState<com.azarnush.ptmalborz.models.LawInfo3> proxyState;

    com_azarnush_ptmalborz_models_LawInfo3RealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.columnInfo = (LawInfo3ColumnInfo) context.getColumnInfo();
        this.proxyState = new ProxyState<com.azarnush.ptmalborz.models.LawInfo3>(this);
    ...
    private static OsObjectSchemaInfo createExpectedObjectSchemaInfo() {
        OsObjectSchemaInfo.Builder builder = new OsObjectSchemaInfo.Builder("LawInfo3", 10, 0);
    ...
    public static LawInfo3ColumnInfo createColumnInfo(OsSchemaInfo schemaInfo) {
        return new LawInfo3ColumnInfo(schemaInfo);
    }
    ...
    public static final class ClassNameHelper {
        public static final String INTERNAL_CLASS_NAME = "LawInfo3";
    }

    @SuppressWarnings("cast")
    public static com.azarnush.ptmalborz.models.LawInfo3 createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        com.azarnush.ptmalborz.models.LawInfo3 obj = realm.createObjectInternal(com.azarnush.ptmalborz.models.LawInfo3.class, true, excludeFields);

        final com_azarnush_ptmalborz_models_LawInfo3RealmProxyInterface objProxy = (com_azarnush_ptmalborz_models_LawInfo3RealmProxyInterface) obj;
        if (json.has("lawId")) {
    ...
    public static com.azarnush.ptmalborz.models.LawInfo3 createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        final com.azarnush.ptmalborz.models.LawInfo3 obj = new com.azarnush.ptmalborz.models.LawInfo3();
        final com_azarnush_ptmalborz_models_LawInfo3RealmProxyInterface objProxy = (com_azarnush_ptmalborz_models_LawInfo3RealmProxyInterface) obj;
        reader.beginObject();
    ...
    private static com_azarnush_ptmalborz_models_LawInfo3RealmProxy newProxyInstance(BaseRealm realm, Row row) {
        // Ignore default values to avoid creating unexpected objects from RealmModel/RealmList fields
        final BaseRealm.RealmObjectContext objectContext = BaseRealm.objectContext.get();
        objectContext.set(realm, row, realm.getSchema().getColumnInfo(com.azarnush.ptmalborz.models.LawInfo3.class), false, Collections.<String>emptyList());
        io.realm.com_azarnush_ptmalborz_models_LawInfo3RealmProxy obj = new io.realm.com_azarnush_ptmalborz_models_LawInfo3RealmProxy();
        objectContext.clear();
        return obj;
    }

    public static com.azarnush.ptmalborz.models.LawInfo3 copyOrUpdate(Realm realm, LawInfo3ColumnInfo columnInfo, com.azarnush.ptmalborz.models.LawInfo3 object, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        ...
        if (cachedRealmObject != null) {
            return (com.azarnush.ptmalborz.models.LawInfo3) cachedRealmObject;
        }

        return copy(realm, columnInfo, object, update, cache, flags);
    }

    public static com.azarnush.ptmalborz.models.LawInfo3 copy(Realm realm, LawInfo3ColumnInfo columnInfo, com.azarnush.ptmalborz.models.LawInfo3 newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        RealmObjectProxy cachedRealmObject = cache.get(newObject);
        if (cachedRealmObject != null) {
            return (com.azarnush.ptmalborz.models.LawInfo3) cachedRealmObject;
        }

        com_azarnush_ptmalborz_models_LawInfo3RealmProxyInterface realmObjectSource = (com_azarnush_ptmalborz_models_LawInfo3RealmProxyInterface) newObject;

        Table table = realm.getTable(com.azarnush.ptmalborz.models.LawInfo3.class);
        ...
        io.realm.com_azarnush_ptmalborz_models_LawInfo3RealmProxy realmObjectCopy = newProxyInstance(realm, row);
        cache.put(newObject, realmObjectCopy);

        return realmObjectCopy;
    }

    public static long insert(Realm realm, com.azarnush.ptmalborz.models.LawInfo3 object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.azarnush.ptmalborz.models.LawInfo3.class);
        long tableNativePtr = table.getNativePtr();
        LawInfo3ColumnInfo columnInfo = (LawInfo3ColumnInfo) realm.getSchema().getColumnInfo(com.azarnush.ptmalborz.models.LawInfo3.class);
        long rowIndex = OsObject.createRow(table);
        cache.put(object, rowIndex);
        String realmGet$lawId = ((com_azarnush_ptmalborz_models_LawInfo3RealmProxyInterface) object).realmGet$lawId();
        if (realmGet$lawId != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.lawIdIndex, rowIndex, realmGet$lawId, false);
        }
        String realmGet$lawTitle = ((com_azarnush_ptmalborz_models_LawInfo3RealmProxyInterface) object).realmGet$lawTitle();
        if (realmGet$lawTitle != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.lawTitleIndex, rowIndex, realmGet$lawTitle, false);
        }
        String realmGet$lawSummary = ((com_azarnush_ptmalborz_models_LawInfo3RealmProxyInterface) object).realmGet$lawSummary();
        ...
        String realmGet$lawContent = ((com_azarnush_ptmalborz_models_LawInfo3RealmProxyInterface) object).realmGet$lawContent();
        ...
        String realmGet$lawSourceLink = ((com_azarnush_ptmalborz_models_LawInfo3RealmProxyInterface) object).realmGet$lawSourceLink();
        ...
        String realmGet$lawTag = ((com_azarnush_ptmalborz_models_LawInfo3RealmProxyInterface) object).realmGet$lawTag();
        if (realmGet$lawTag != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.lawTagIndex, rowIndex, realmGet$lawTag, false);
        }
        String realmGet$shortKey = ((com_azarnush_ptmalborz_models_LawInfo3RealmProxyInterface) object).realmGet$shortKey();
        if (realmGet$shortKey != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.shortKeyIndex, rowIndex, realmGet$shortKey, false);
        }
        String realmGet$visibleStatusId = ((com_azarnush_ptmalborz_models_LawInfo3RealmProxyInterface) object).realmGet$visibleStatusId();
        ...
        String realmGet$registerDate = ((com_azarnush_ptmalborz_models_LawInfo3RealmProxyInterface) object).realmGet$registerDate();
        ...
        String realmGet$lawGroupRefId = ((com_azarnush_ptmalborz_models_LawInfo3RealmProxyInterface) object).realmGet$lawGroupRefId();
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        long tableNativePtr = table.getNativePtr();
        LawInfo3ColumnInfo columnInfo = (LawInfo3ColumnInfo) realm.getSchema().getColumnInfo(com.azarnush.ptmalborz.models.LawInfo3.class);
        com.azarnush.ptmalborz.models.LawInfo3 object = null;
        while (objects.hasNext()) {
            object = (com.azarnush.ptmalborz.models.LawInfo3) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.azarnush.ptmalborz.models.LawInfo3 object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.azarnush.ptmalborz.models.LawInfo3.class);
    ...
    public static com.azarnush.ptmalborz.models.LawInfo3 createDetachedCopy(com.azarnush.ptmalborz.models.LawInfo3 realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.azarnush.ptmalborz.models.LawInfo3 unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.azarnush.ptmalborz.models.LawInfo3();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.azarnush.ptmalborz.models.LawInfo3) cachedObject.object;
            }
            unmanagedObject = (com.azarnush.ptmalborz.models.LawInfo3) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_azarnush_ptmalborz_models_LawInfo3RealmProxyInterface unmanagedCopy = (com_azarnush_ptmalborz_models_LawInfo3RealmProxyInterface) unmanagedObject;
        com_azarnush_ptmalborz_models_LawInfo3RealmProxyInterface realmSource = (com_azarnush_ptmalborz_models_LawInfo3RealmProxyInterface) realmObject;
    ...
    public String toString() {
        ...
        StringBuilder stringBuilder = new StringBuilder("LawInfo3 = proxy[");
    ...
    public boolean equals(Object o) {
        ...
        com_azarnush_ptmalborz_models_LawInfo3RealmProxy aLawInfo3 = (com_azarnush_ptmalborz_models_LawInfo3RealmProxy)o;

        String path = proxyState.getRealm$realm().getPath();
        String otherPath = aLawInfo3.proxyState.getRealm$realm().getPath();
        if (path != null ? !path.equals(otherPath) : otherPath != null) return false;

        String tableName = proxyState.getRow$realm().getTable().getName();
        String otherTableName = aLawInfo3.proxyState.getRow$realm().getTable().getName();
        if (tableName != null ? !tableName.equals(otherTableName) : otherTableName != null) return false;

        if (proxyState.getRow$realm().getIndex() != aLawInfo3.proxyState.getRow$realm().getIndex()) return false;
